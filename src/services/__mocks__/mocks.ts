export const taxCalculationShippingAddressMock = {
...
export const itemTaxCalculationMock = {
  item: {
    id: "item_1",
    title: "item_title_1",
    unit_price: 10,
...
export const stripeTaxTransactionMock = {
...
export const stripeTaxReversalMock = {
...
export const orderMock = {
  ...
  total: 0,
  currency_code: "usd",
  metadata: { taxTransactionId: stripeTaxTransactionMock.id },
}

export const stripeMockService = () => {
  return {
    fetchTaxCalculation: async () => await stripeCalcMock,
    createFromCalculation: async () => await stripeTaxTransactionMock,
    createReversal: async () => await stripeTaxReversalMock,
  };
};
